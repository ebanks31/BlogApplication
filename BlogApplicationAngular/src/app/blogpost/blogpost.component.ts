...
export class BlogPostComponent implements OnInit {
  ...
  constructor(private blogService: BlogService,
    ...
    this.route.params.subscribe(data => this.blogPostId = data.blogPostId,
      error => console.log(error));
  }
  ...
  getBlogPostByBlogId(blogid: number, blogPostId: number): void {
    ...
    this.blogService.getBlogPostByBlogId(blogid, blogPostId)
  ...
  savePost($event: any): void {
    ...
    this.blogService.saveBlogPost(this.blogId, this.blogPostId, this.blogPost).subscribe(data => console.log(data),
      error => console.log(error));
