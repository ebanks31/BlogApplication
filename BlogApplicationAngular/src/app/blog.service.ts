...
export class BlogService {
  ...
  addBlog(blog: any) {
    ...
    return this.http.post(blogPostsByBlogIdUrlFinal, JSON.stringify(blog), {
  ...
  getBlogPostsByBlogId(blogId: number): Observable<any> {
    ...
    console.log(
      "this.blogPostsByBlogIdUrl: " + this.blogPostsByBlogIdUrl + blogId
    );
    console.log("this.this.blogUrl : " + this.blogUrl + String(blogId));

    let blogPostsByBlogIdUrlFinal = this.blogUrl
      .concat(String(blogId))
      .concat(this.blogPostsByBlogIdUrl);
    console.log(
      "this.blogPostsByBlogIdUrl final: " + blogPostsByBlogIdUrlFinal
    );
  ...
  getBlogPostByBlogId(blogId: number, blogPostId: number): Observable<any> {
    ...
    let blogUrlFinal =
      this.blogUrl + blogId + this.blogPostByBlogIdUrl + blogPostId;
  ...
  addBlogPost(blogPost: BlogPostModel, blogId: number) {
    ...
    let addBlogPostUrl = this.blogUrl
      .concat(String(blogId))
      .concat(this.blogPostByBlogIdUrl)
      .concat("post/")
      .concat(this.add);
    console.log("addBlogPostUrl " + addBlogPostUrl);

    return this.http.post(addBlogPostUrl, JSON.stringify(blogPost), {
      headers: this.headers,
      responseType: "json"
    });
  }
  ...
  saveBlogPost(
    ...
    let saveBlogPostUrl = this.blogUrl
      .concat(String(blogId))
      .concat(this.blogPostByBlogIdUrl)
      .concat(this.postNoPrefixSlash)
      .concat(this.edit)
      .concat(String(blogPostId));
    console.log("saveBlogPostUrl " + saveBlogPostUrl);
    console.log("blogPost " + blogPost);
    console.log("JSON.stringify({blogPost} " + JSON.stringify(blogPost));

    return this.http.put(saveBlogPostUrl, JSON.stringify(blogPost), {
      headers: this.headers,
      responseType: "json"
    });
  }
  ...
  deleteBlogPost(blogPostId: number, blogId: number): Observable<any> {
    ...
    let deleteBlogPostUrl = this.blogUrl
      .concat(String(blogId))
      .concat(this.blogPostByBlogIdUrl)
      .concat(this.postNoPrefixSlash)
      .concat(this.delete)
    ...
    return this.http.delete(deleteBlogPostUrl, {
      headers: this.headers,
      responseType: "json"
    });
  }
