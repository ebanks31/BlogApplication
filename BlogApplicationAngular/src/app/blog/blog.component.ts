...
export class BlogComponent implements OnInit {
  ...
  getBlogsPostsByBlogId(blogid: number): void {
    ...
    this.blogService.getBlogPostsByBlogId(blogid).subscribe(
  ...
  deleteByBlogPostAndBlogId(blogpostId: number, blogid: number): void {
    ...
    this.blogService.deleteBlogPost(blogpostId, blogid).subscribe(
      data => (this.blog = data),
      error => console.log(error)
    );
  ...
  editBlogPost(blogPostId: number): void {
    this.router.navigate([
      "blogs/blog/" + this.blogId + "/posts/" + blogPostId
    ]);
  }
