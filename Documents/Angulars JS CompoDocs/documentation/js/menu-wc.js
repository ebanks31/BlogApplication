...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">blog-application documentation</a>
                </li>
                ...
                <li class="chapter">
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-d367065b3e345e562cef82fef7e3ada6"' : 'data-target="#xs-components-links-module-AppModule-d367065b3e345e562cef82fef7e3ada6"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-d367065b3e345e562cef82fef7e3ada6"' :
                                            'id="xs-components-links-module-AppModule-d367065b3e345e562cef82fef7e3ada6"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/AddBlogComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">AddBlogComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/AddBlogPostComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">AddBlogPostComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/DeveloperComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">DeveloperComponent</a>
                                            </li>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/BlogModel.html" data-type="entity-link">BlogModel</a>
                            </li>
                            <li class="link">
                                <a href="classes/BlogPostModel.html" data-type="entity-link">BlogPostModel</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/BlogpostService.html" data-type="entity-link">BlogpostService</a>
                                </li>
                                <li class="link">
